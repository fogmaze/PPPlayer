...
if __name__ == "__main__":
    ...
    argparser.add_argument("--mode", default="better4", type=str)
    ...
    if not os.path.isdir("ball_simulate/v4/dataset"):
        os.mkdir("ball_simulate/v4/dataset")

    simulate(GUI=args.GUI, dataLength=args.l, outputFileName="ball_simulate/v4/dataset/{}.train.bin".format(args.n), mode=args.mode)
    simulate(GUI=args.GUI, dataLength=10000, outputFileName="ball_simulate/v4/dataset/{}.valid.bin".format(args.n), mode=args.mode)
    pass
